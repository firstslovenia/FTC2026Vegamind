...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(8.4, 0.3, 0.3,
    ...
    public static double kStatic = 0.0135;
    ...
    public static double MAX_ANG_VEL = 3.82;
    public static double MAX_ANG_ACCEL = Math.toRadians(198.135);
